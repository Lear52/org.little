...
public class ufpsDoc {
       ...
       public void   setEDNO      (String arg){ref_id.setEDNO   (arg);}     
       public void   setEDDate    (String arg){ref_id.setEDDate (arg);}     
       public void   setEDAutor   (String arg){ref_id.setEDAutor(arg);}     

       public String getFormat    (){return format      ;}     
       public String getType      (){return type        ;}      
       public String getID        (){return id          ;}        

       public String getEDNO      (){return ref_id.getEDNO   ();}
       public String getEDDate    (){return ref_id.getEDDate ();}
       public String getEDAutor   (){return ref_id.getEDAutor();}


       public String toString(){
                               return 
                                " doc_format:"+         ((format==null)?"":format)        
                               +" doc_type:"+           ((type  ==null)?"":type)      
                               +" doc_id:"+             ((id    ==null)?"":id)      
                               +ref_id.toString()   
                               ;
       }
