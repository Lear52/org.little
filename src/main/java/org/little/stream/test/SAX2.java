...
public class SAX2 {
       private static final Logger logger = LoggerFactory.getLogger(SAX2.class);

       public static void set(ufpsMsg msg,String element,String data, XMLStreamWriter xml_writer){
       ...
       //}
       private static String parse(ufpsMsg msg,byte[] buf,int field_add) throws Except{
               ...
               try {
                   ...
                   while (is_run) {
                          ...
                          case XMLStreamConstants.START_DOCUMENT:
                               ...
                               if(ver==null)ver="1.0";
                               if(xml_writer!=null)xml_writer.writeStartDocument(encoding,ver);                                 
                               break;
                          case XMLStreamConstants.START_ELEMENT:
                               ...
                               current_namespace=obj.getPrefix();
                               if(xml_writer!=null)xml_writer.writeStartElement(current_namespace, current_element, obj.getNamespaceURI());
                               //---------------------------------------------------------------------------------------------------------
                               {
                                    for (int i = 1; i < xml_reader.getNamespaceCount(); i++) {
                                      ...
                                      if(xml_writer!=null)xml_writer.writeNamespace(current_namespace,  uri);
                                     }
                               }   
                               //---------------------------------------------------------------------------------------------------------
                               {
                                     for (int i = 0; i < xml_reader.getAttributeCount(); i++) {
                                       ...
                                       if(xml_writer!=null)xml_writer.writeAttribute(qName, value);
                                     }
                               }
                               //---------------------------------------------------------------------------------------------------------
                               break;
                          case XMLStreamConstants.CHARACTERS:
                                  set(msg,current_element,xml_reader.getText(),xml_writer);
                                  if(xml_writer!=null)xml_writer.writeCharacters(xml_reader.getText());
                               break;
                          case XMLStreamConstants.END_ELEMENT:
                               obj=xml_reader.getName();
                               setf(obj.getLocalPart());
                               
                               if(xml_writer!=null)xml_writer.writeEndElement();
                               break;
                          ...
                          case XMLStreamConstants.NAMESPACE:
                               ...
                               if(xml_writer!=null)xml_writer.writeNamespace(obj2.getPrefix(),  obj2.getNamespaceURI());
