...
public class TestServer {
       ...
       public static boolean is_debeg=false;

       public TestServer() throws URISyntaxException{
              //debug     =true;
       ...
       public TestServer(String _url) throws URISyntaxException{
              username   =null;
              password   =null;
              httpclient =null;
              context    =null;
       ...
       public TestServer(String _url,String u,String p) throws URISyntaxException{
              httpclient =null;
              context    =null;
              uri        =new URI(_url);
       ...
       protected String get(ByteArrayOutputStream os) throws Exception{
              try {
                   _open();
                   _get(os);
       ...
       protected void sent(byte[] out,String filename) throws Exception{
              try {
                   _open();
                   _sent(out,filename);
              }catch(Exception e){
       ...
       public static void main(String[] args) throws Exception {
              ...
              TestServer cln=new TestServer();
              String     url_get;
              String     url_post;

              if(args.length<3){
                 System.out.println(" [get|post] [xxxxx] [url]");
                 return;
              }
              cln.setUser("av");
              cln.setPassword("123");

              url_get=args[2]+"/stream/"+"get";
              url_post=args[2]+"/stream/"+"post";
              ...
              while(!Thread.currentThread().isInterrupted()){
                  ...
                  System.out.print(count+" executing request :" + url_get+"\r");
                  cln.setURL(url_get); 
                  ByteArrayOutputStream os=new ByteArrayOutputStream();
                  cln._get(os);
                  byte[] out = os.toByteArray();
                  if(is_debeg)System.out.write(out);

                  System.out.print(count+" executing request :" + url_post+"\r");
                  cln.setURL(url_post); 
                  cln._sent(def_msg2.getBytes(),"test.xml");
